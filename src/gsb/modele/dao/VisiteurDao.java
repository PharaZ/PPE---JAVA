...
public class VisiteurDao {
	...
	public static Visiteur rechercher(String matricule){
		...
		ResultSet reqSelection = ConnexionMySql.execReqSelection("select * from VISITEUR where MATRICULEVIST ='"+matricule+"'");
		try {
			...
			System.out.println("erreur reqSelection.next() pour la requ�te - select * from VISITEUR where MATRICULEVIST ='"+matricule+"'");
			e.printStackTrace();
			}
	...
	public static ArrayList<Visiteur> retournerCollectionDesVisiteurs(){
		...
		ResultSet reqSelection = ConnexionMySql.execReqSelection("select MATRICULEVIST from VISITEUR");
		try{
